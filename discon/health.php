          ...
          <div class="row">
            <div class="col-10 mx-auto">
              <div class="row p-4 justify-content-between ">
                <h2 class=" mb-5 text-center"><strong class="fw-bold"><i class="fa-solid fa-dumbbell fa-beat me-2"></i>Health & fitness</strong></h2>
                <div class="col-5">
                    <div class="card custom-card" >
                        ...
                        <h5 class="card-text fw-bold">AmraActive fitness & Gym</h5>
                            ...
                            <a href="./deal.php" class="btn btn-outline-info">Go somewhere</a>
                        </div>
                        </div>
                </div>
                <div class="col-5">
